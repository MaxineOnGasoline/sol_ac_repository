...
{id='76561199443140671', teamNumber=175, teamName='ThermalGrizzly SimracingDream Team', name='Bartosz  Grzywacz', nationality='POL', isLan=true},
...
{id='76561199443676081', teamNumber=275, teamName='MoveCenter SimracingDream Team', name='Kamil  Adamczyk', nationality='POL', isLan=true},
...
{id='76561198260119183', teamNumber=711, teamName='Arachnid Racing', name='evangelos plakidas', nationality='GRC', isLan=true},
...
{id='76561199023342942', teamNumber=22, teamName='Brawn Endurance Racing', name='Kacper Niemczyk', nationality='POL', isLan=false},
...
{id='76561199229096702', teamNumber=20, teamName='OVERCREST Racing Team', name='Tomasz Zbroja', nationality='POL', isLan=true},
...
{id='76561198277132938', teamNumber=171, teamName='EQP Racing Team ', name='Paweł Maliszewski ', nationality='POL', isLan=false},
{id='76561198962220373', teamNumber=171, teamName='EQP Racing Team ', name='Szymon Mrochem ', nationality='POL', isLan=false},
{id='76561198421073793', teamNumber=171, teamName='EQP Racing Team ', name='Krzysztof Kosiński', nationality='POL', isLan=false},
{id='76561198185998989', teamNumber=171, teamName='EQP Racing Team ', name='Bartosz  Mikoda', nationality='POL', isLan=false},
...
{id='76561198805161318', teamNumber=14, teamName='Speedscape Syndicate', name='Akram Chouchen', nationality='TUN', isLan=true},
{id='76561198828646049', teamNumber=14, teamName='Speedscape Syndicate', name='Cezary Szwaguliński', nationality='POL', isLan=true},
{id='76561198105740240', teamNumber=14, teamName='Speedscape Syndicate', name='Konstantin Miletić', nationality='SRB', isLan=true},
...
{id='76561198994994988', teamNumber=400, teamName='Apex One Kicia Esports | Bravo', name='Adrian Raszke', nationality='POL', isLan=false},
{id='76561199048022032', teamNumber=400, teamName='Apex One Kicia Esports | Bravo', name='Konrad Böhm', nationality='POL', isLan=false},
{id='76561198343267497', teamNumber=400, teamName='Apex One Kicia Esports | Bravo', name='Jakub Kozłowski', nationality='POL', isLan=false},
{id='76561198041315474', teamNumber=400, teamName='Apex One Kicia Esports | Bravo', name='David Śliwka', nationality='POL', isLan=false},
...
{id='76561199178062993', teamNumber=51, teamName='Apex One Free Bird', name='Adrian Kobacki', nationality='POL', isLan=true},
{id='76561198077381614', teamNumber=51, teamName='Apex One Free Bird', name='Kacper Smirnow', nationality='POL', isLan=true},
{id='76561198142953806', teamNumber=51, teamName='Apex One Free Bird', name='Daniel Rataj', nationality='POL', isLan=true},
{id='76561198221892956', teamNumber=51, teamName='Apex One Free Bird', name='Jakub Tarasiuk', nationality='POL', isLan=true},
{id='76561198109138934', teamNumber=771, teamName='Apex One USAF', name='Eryk Szymendera', nationality='POL', isLan=true},
{id='76561198093217073', teamNumber=771, teamName='Apex One USAF', name='Wiktor Behrendt', nationality='POL', isLan=true},
{id='76561198144472205', teamNumber=771, teamName='Apex One USAF', name='Filip Przygoński', nationality='POL', isLan=true},
{id='76561198211379496', teamNumber=771, teamName='Apex One USAF', name='Kamil Hołub', nationality='POL', isLan=true},
{id='76561198360003609', teamNumber=888, teamName='Apex One Qubic System', name='Wojtek Niewęgłowski', nationality='POL', isLan=false},
{id='76561198273387549', teamNumber=888, teamName='Apex One Qubic System', name='Szymon Górka', nationality='POL', isLan=false},
{id='76561198118903734', teamNumber=888, teamName='Apex One Qubic System', name='Wojtek Surosz', nationality='POL', isLan=false},
{id='76561198416205184', teamNumber=888, teamName='Apex One Qubic System', name='Robert Radaj', nationality='POL', isLan=false},
{id='76561198194524875', teamNumber=43, teamName='Apex One AMG', name='Adrian Faber', nationality='POL', isLan=false},
{id='76561198107963325', teamNumber=43, teamName='Apex One AMG', name='Marcin Rybaczuk', nationality='POL', isLan=false},
{id='76561198262787782', teamNumber=43, teamName='Apex One AMG', name='Dawid Fryzowicz', nationality='POL', isLan=false},
{id='76561198211245596', teamNumber=43, teamName='Apex One AMG', name='Rafał Szołtysek', nationality='POL', isLan=false},
{id='76561198032692915', teamNumber=71, teamName='Apex One Acura Black', name='Patryk Krutyj', nationality='POL', isLan=false},
{id='76561198157333224', teamNumber=71, teamName='Apex One Acura Black', name='Łukasz Sokół', nationality='POL', isLan=false},
{id='76561198030143608', teamNumber=71, teamName='Apex One Acura Black', name='Kamil Putoń', nationality='POL', isLan=false},
{id='76561198227476624', teamNumber=71, teamName='Apex One Acura Black', name='Wojciech Bobrowicz', nationality='POL', isLan=false},
{id='76561198041557438', teamNumber=101, teamName='Apex One Acura White', name='Szymon Piotrowski', nationality='POL', isLan=false},
{id='76561198208193368', teamNumber=101, teamName='Apex One Acura White', name='Mikołaj Nowicki', nationality='POL', isLan=false},
{id='76561197993587345', teamNumber=101, teamName='Apex One Acura White', name='Mateusz Bogusz', nationality='POL', isLan=false},
{id='76561198058138323', teamNumber=101, teamName='Apex One Acura White', name='Rafał Dąbal', nationality='POL', isLan=false},
...
{id='000', teamNumber=275, teamName='MoveCenter SimracingDream Team', name='Adam Jakus', nationality='POL', isLan=true},
{id='76561198058152715', teamNumber=275, teamName='MoveCenter SimracingDream Team', name='Jeremiasz Szlosek', nationality='POL', isLan=true},
{id='0001', teamNumber=275, teamName='MoveCenter SimracingDream Team', name='Julia Obłój', nationality='POL', isLan=true}
}
